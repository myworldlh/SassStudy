...
# 设置compass的工作环境(development开发,production生产)
environment  = :development

# Set th tiso the root of your project when deployed:
http_path = "/"  # 请求的路径配置，可以使用网络路径如：http://baidu.com/demo-project/images/
css_dir = "stylesheets"
sass_dir = "sass"
images_dir = "images" # 图片的存放路径，这样才能使用compass操作图片的方法
javascripts_dir = "javascripts"
fonts_dir = "fonts" # fonts_dir 字体文件引入路径
